                    ...
                    <table align="center" width="590" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <td align="center" style="font-family:Helvetica,sans-serif;mso-line-height-rule:exactly;text-align:center;line-height:40px;color:#333333;">
                                    <div><!--[if mso]>
                                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ route('reservations.show', compact('id')) }}" style="height:36px;v-text-anchor:middle;width:200px;" arcsize="56%" strokecolor="#adadad" fillcolor="#fafafb">
                                        <w:anchorlock/>
                                        <center style="color:#2f353e;font-family:sans-serif;font-size:13px;font-weight:bold;">Voir la réservation</center>
                                      </v:roundrect>
                                    <![endif]--><a href="{{ route('reservations.show', compact('id')) }}"
